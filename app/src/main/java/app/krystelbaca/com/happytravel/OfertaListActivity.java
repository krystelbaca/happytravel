...
/**
 * An activity representing a list of Ofertas. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link OfertaDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 */
public class OfertaListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oferta_list);
        ...
        View recyclerView = findViewById(R.id.oferta_list);
        assert recyclerView != null;
        setupRecyclerView((RecyclerView) recyclerView);

        if (findViewById(R.id.oferta_detail_container) != null) {
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.oferta_list_content, parent, false);
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.oferta_detail_container, fragment)
                                .commit();
                    } else {
